    ...
    <div className="flex justify-center pt-8">
      ...
      >
        <motion.div
          ...
          className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-primary/12 text-primary-bright shadow-[0_0_28px_-4px_oklch(0.60_0.185_27_/_0.5)]"
        >
